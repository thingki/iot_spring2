...
<body>
	...
	contentType :<select id="conType" name="conType">
		...
		<input type="button" value="jsonRequestBodyToMap" onclick="go(this)">1<br>
		<input type="button" value="jsonRequestBodyToObject" onclick="go(this)">2<br>
		<input type="button" value="formRequestBodyToMap" onclick="go(this)">3<br>
		<input type="button" value="formRequestBodyToObject" onclick="go(this)">4<br>
		<input type="button" value="jsonRequestParamToMap" onclick="go(this)">5<br>
		<input type="button" value="jsonRequestParamToObject" onclick="go(this)">6<br>
		<input type="button" value="formRequestParamToMap" onclick="go(this)">7<br>
		<input type="button" value="formRequestParamToObject" onclick="go(this)">8<br>
		<input type="button" value="formToMap" onclick="go(this)">9<br>
		<input type="button" value="formToObject" onclick="go(this)">10<br>
	</form>
...
<script type="text/javascript" charset="utf-8">
   function go(btn){
      ...
      var conType = btn.form.conType.value;/* document.getElementById("conType").value; */
      var type = btn.form.type.value;/* document.getElementById("type").value; */
      ...
      /* RequestBody = 반드시 send, post, json */
      /* 1 */
      ...
      /* 5 */   
         ...
         // 모든 타입, 컨테트타입 모두 다 에러나지 않으나 key : value매핑안됨
         btn.form.submit(); 
